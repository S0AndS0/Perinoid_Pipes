...
## Variables for verision two of main script
export Var_install_v2_name="version_two.sh"
export Var_encrypt_pipe_three_location="${PWD}/encrypt_one.pipe"
export Var_encrypt_pipe_three_log="${PWD}/encrypt_one.log"
export Var_encrypted_three_location="${PWD}/encrypt_one.gpg"
export Var_encrypted_three_bulk_dir="${PWD}/bulk_encryption"
export Var_raw_test_three_location="${PWD}/raw_strings.txt"
export Var_decrypt_raw_three_location="${PWD}/decrypt_one.txt"
