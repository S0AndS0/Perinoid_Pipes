...
if [ -e "${Var_install_path}/${Var_install_name}" ]; then
	...
	Func_run_sanely "${Var_install_script} Var_debugging=2 Var_pipe_permissions=660 Var_gpg_recipient=${Var_gnupg_email} Var_log_rotate_recipient=${Var_gnupg_email}" "0"
