...
echo "# ${Var_script_name} running: Script_Helpers/Paranoid_Pipes_Scenario_One.sh --input-file=\"${Var_encrypted_location}\" --output-file=\"${Var_decrypted_location}\" --pass=\"${Var_pass_location}\" --bulk-input-dir=\"${Var_encrypted_bulk_dir}\" --bulk-output-dir=\"${Var_bulk_decryption_dir}\""
Script_Helpers/Paranoid_Pipes_Scenario_One.sh --input-file="${Var_encrypted_location}" --output-file="${Var_decrypted_location}" --pass="${Var_pass_location}" --bulk-input-dir="${Var_encrypted_bulk_dir}" --bulk-output-dir="${Var_bulk_decryption_dir}"
_exit_status=$?
