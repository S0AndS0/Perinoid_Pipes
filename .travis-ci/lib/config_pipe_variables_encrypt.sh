...
Arr_encrypt_opts+=( "---Var_log_file_name=/tmp/Peranoid_Pipes/encrypt.log" )
#export Var_log_file_name="/tmp/Peranoid_Pipes/encrypt.log"
Arr_encrypt_opts+=( "---Var_pipe_file_name=/tmp/Peranoid_Pipes/encrypt.pipe" )
#export Var_pipe_file_name="/tmp/Peranoid_Pipes/encrypt.pipe"
Arr_encrypt_opts+=( "---Var_parsing_output_file=/tmp/Peranoid_Pipes/encrypt.gpg" )
...
Arr_encrypt_opts+=( "---Var_parsing_bulk_out_dir=/tmp/Peranoid_Pipes" )
